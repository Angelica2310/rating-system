    ...
    <Form.Root className="w-[260px]" action={handleSubmit}>
      <Form.Field className="mb-2.5 grid" name="username">
        ...
        <Form.Control asChild>
          <input
            className="box-border inline-flex h-[35px] w-full resize-none appearance-none items-center justify-center rounded bg-blackA2 px-2.5 text-[15px] leading-none text-blue shadow-[0_0_0_1px] shadow-blackA6 outline-none selection:bg-blue selection:text-white hover:shadow-[0_0_0_1px_#3581b8] focus:shadow-[0_0_0_2px_b#3581b8]"
            required
          />
        </Form.Control>
      </Form.Field>
